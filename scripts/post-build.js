...
const filesToCopy = [
  ...
  { src: 'public/icon-144.png', dest: 'dist/icon-144.png' },
  { src: 'public/icon-152.png', dest: 'dist/icon-152.png' },
  { src: 'public/icon-180.png', dest: 'dist/icon-180.png' },
  { src: 'public/icon-192.png', dest: 'dist/icon-192.png' },
  { src: 'public/icon-256.png', dest: 'dist/icon-256.png' },
  { src: 'public/icon-384.png', dest: 'dist/icon-384.png' },

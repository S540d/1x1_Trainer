...
- **[TESTING.md](TESTING.md)** - 3-Tier Branch-Strategie und Deployment-Workflow
- **[AUTOMATION_SETUP.md](AUTOMATION_SETUP.md)** - CI/CD, Pre-Commit Hooks, Validation
- **[ANDROID_APP_LINKS.md](ANDROID_APP_LINKS.md)** - Android Deep Links Konfiguration
...
- [Web App (Production)](https://s540d.github.io/1x1_Trainer/)
- [Web App (Staging)](https://s540d.github.io/1x1_Trainer/staging/)
- [Web App (Testing)](https://s540d.github.io/1x1_Trainer/testing/)
